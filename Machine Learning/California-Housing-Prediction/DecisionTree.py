...
df = pd.read_csv("california_housing.csv")               # Load the California Housing dataset
print("Shape : ", df.shape)                              # Display number of rows and columns
...
model = DecisionTreeRegressor(random_state=42)           # Create Decision Tree Regression model
